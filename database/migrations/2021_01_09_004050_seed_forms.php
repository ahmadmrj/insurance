...
class SeedForms extends Migration
{
    ...
    public function up()
    {
        DB::table('forms')->insert([
            ...
            ['template' => 'trucking_quick_quote', 'name' => null, 'alias' => 'gvw', 'values' => null, 'multiple' => true, 'group_id' => 'vehicle'],
            ['template' => 'trucking_quick_quote', 'name' => null, 'alias' => 'value ($)', 'values' => null, 'multiple' => true, 'group_id' => 'vehicle'],
            ['template' => 'trucking_quick_quote', 'name' => null, 'alias' => 'ded', 'values' => null, 'multiple' => true,'group_id' => 'vehicle'],            
